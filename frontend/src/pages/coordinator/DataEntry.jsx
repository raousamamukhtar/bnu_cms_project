  ...
  return (
    <div className="min-h-screen bg-slate-50 py-6 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Events Card - Separate */}
        <Card className="bg-white border-2 border-emerald-100 shadow-lg hover:shadow-xl transition-all duration-300 rounded-xl overflow-hidden mt-6">
          <form onSubmit={handleSubmitEvents}>
            <div className="bg-gradient-to-r from-emerald-600 to-emerald-700 p-5">
              <div>
                <h3 className="text-lg font-bold text-white">Monthly Events</h3>
                <p className="text-sm text-emerald-100 mt-0.5">Add events and activities for this month (Optional)</p>
              </div>
            </div>
